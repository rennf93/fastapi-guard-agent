...
class TestBufferBasic:
    ...
    @pytest.mark.asyncio
    async def test_add_event(self, buffer: EventBuffer, security_event: SecurityEvent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_add_metric(self, buffer: EventBuffer, security_metric: SecurityMetric) -> None:
    ...
    @pytest.mark.asyncio
    async def test_flush_events(self, buffer: EventBuffer, security_event: SecurityEvent) -> None:
        await buffer.add_event(security_event)
    ...
    @pytest.mark.asyncio
    async def test_flush_metrics(self, buffer: EventBuffer, security_metric: SecurityMetric) -> None:
        await buffer.add_metric(security_metric)
    ...
    @pytest.mark.asyncio
    async def test_clear_buffer(self, buffer: EventBuffer, security_event: SecurityEvent, security_metric: SecurityMetric) -> None:
        await buffer.add_event(security_event)
        await buffer.add_metric(security_metric)
...
class TestBufferRedisIntegration:
    ...
    @pytest.mark.asyncio
    async def test_initialize_redis(self, buffer: EventBuffer, mock_redis_handler: AsyncMock) -> None:
        with patch.object(buffer, '_load_from_redis', new_callable=AsyncMock) as mock_load:
    ...
    @pytest.mark.asyncio
    async def test_add_event_with_redis(self, buffer: EventBuffer, security_event: SecurityEvent, mock_redis_handler: AsyncMock) -> None:
        await buffer.initialize_redis(mock_redis_handler)
        with patch.object(buffer, '_persist_event_to_redis', new_callable=AsyncMock) as mock_persist:
            await buffer.add_event(security_event)
            mock_persist.assert_awaited_once_with(security_event)


    @pytest.mark.asyncio
    async def test_add_metric_with_redis(self, buffer: EventBuffer, security_metric: SecurityMetric, mock_redis_handler: AsyncMock) -> None:
        await buffer.initialize_redis(mock_redis_handler)
        with patch.object(buffer, '_persist_metric_to_redis', new_callable=AsyncMock) as mock_persist:
            await buffer.add_metric(security_metric)
            mock_persist.assert_awaited_once_with(security_metric)


    @pytest.mark.asyncio
    async def test_flush_events_with_redis(self, buffer: EventBuffer, security_event: SecurityEvent, mock_redis_handler: AsyncMock) -> None:
        await buffer.initialize_redis(mock_redis_handler)
        await buffer.add_event(security_event)
        with patch.object(buffer, '_clear_events_from_redis', new_callable=AsyncMock) as mock_clear:
            await buffer.flush_events()
            mock_clear.assert_awaited_once_with(1)


    @pytest.mark.asyncio
    async def test_flush_metrics_with_redis(self, buffer: EventBuffer, security_metric: SecurityMetric, mock_redis_handler: AsyncMock) -> None:
        await buffer.initialize_redis(mock_redis_handler)
        await buffer.add_metric(security_metric)
        with patch.object(buffer, '_clear_metrics_from_redis', new_callable=AsyncMock) as mock_clear:
            await buffer.flush_metrics()
            mock_clear.assert_awaited_once_with(1)


    @pytest.mark.asyncio
    async def test_clear_buffer_with_redis(self, buffer: EventBuffer, mock_redis_handler: AsyncMock) -> None:
        await buffer.initialize_redis(mock_redis_handler)
        with patch.object(buffer, '_clear_redis_buffers', new_callable=AsyncMock) as mock_clear:
            await buffer.clear_buffer()
...
class TestBufferAutoFlush:
    ...
    @pytest.mark.asyncio
    async def test_auto_flush_loop(self, buffer: EventBuffer, agent_config: AgentConfig) -> None:
        agent_config.flush_interval = 0.1
        buffer = EventBuffer(agent_config)
        with patch.object(buffer, '_flush_if_needed', new_callable=AsyncMock) as mock_flush:
            await buffer.start_auto_flush()
    ...
    @pytest.mark.asyncio
    async def test_auto_flush_loop_exception(self, buffer: EventBuffer, caplog: LogCaptureFixture) -> None:
        buffer.config.flush_interval = 0.1
        with patch.object(buffer, '_flush_if_needed', side_effect=Exception("Test Error")):
            await buffer.start_auto_flush()
            await asyncio.sleep(0.15)
            await buffer.stop_auto_flush()
...
class TestBufferFlushIfNeeded:
    ...
    @pytest.mark.asyncio
    async def test_flush_if_needed_by_size(self, buffer: EventBuffer, security_event: SecurityEvent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_flush_if_needed_by_time(self, buffer: EventBuffer, security_event: SecurityEvent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_flush_if_needed_not_needed(self, buffer: EventBuffer, security_event: SecurityEvent) -> None:
...
class TestBufferRedisPersistence:
    ...
    @pytest.mark.asyncio
    async def test_persist_event_to_redis(self, buffer: EventBuffer, security_event: SecurityEvent, mock_redis_handler: AsyncMock) -> None:
        await buffer.initialize_redis(mock_redis_handler)
    ...
    @pytest.mark.asyncio
    async def test_persist_metric_to_redis(self, buffer: EventBuffer, security_metric: SecurityMetric, mock_redis_handler: AsyncMock) -> None:
        await buffer.initialize_redis(mock_redis_handler)
    ...
    @pytest.mark.asyncio
    async def test_persist_to_redis_no_handler(self, buffer: EventBuffer, security_event: SecurityEvent, security_metric: SecurityMetric) -> None:
    ...
    @pytest.mark.asyncio
    async def test_persist_event_to_redis_exception(self, buffer: EventBuffer, security_event: SecurityEvent, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
    ...
    @pytest.mark.asyncio
    async def test_persist_metric_to_redis_exception(self, buffer: EventBuffer, security_metric: SecurityMetric, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        mock_redis_handler.set_key.side_effect = Exception("Redis Error")
        await buffer.initialize_redis(mock_redis_handler)
        await buffer._persist_metric_to_redis(security_metric)
...
class TestBufferLoadFromRedis:
    ...
    @pytest.mark.asyncio
    async def test_load_from_redis(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, security_event: SecurityEvent, security_metric: SecurityMetric, caplog: LogCaptureFixture) -> None:
        event_key = "event_123"
        ...
        assert f"Failed to load event from Redis key agent_events:{unknown_key}: No data found for key" in caplog.text
    ...
    @pytest.mark.asyncio
    async def test_load_from_redis_exception(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
    ...
    @pytest.mark.asyncio
    async def test_load_from_redis_item_exception(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        ...
        await buffer.initialize_redis(mock_redis_handler)
        assert "Failed to load event from Redis key agent_events:event_123: Get Key Error" in caplog.text


    @pytest.mark.asyncio
    async def test_load_from_redis_deserialize_fail(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        mock_redis_handler.keys.return_value = ["agent_events:event_123"]
    ...
    @pytest.mark.asyncio
    async def test_load_from_redis_model_validation_fail(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        mock_redis_handler.keys.return_value = ["agent_events:event_123"]
    ...
    @pytest.mark.asyncio
    async def test_load_from_redis_unknown_key(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        mock_redis_handler.keys.return_value = ["agent_events:unknown_key"]
        mock_redis_handler.get_key.return_value = None # Simulate get_key returning None for an unknown key

        await buffer.initialize_redis(mock_redis_handler)

        assert len(buffer.event_buffer) == 0
        assert len(buffer.metric_buffer) == 0
        assert "Failed to load event from Redis key agent_events:unknown_key: No data found for key" in caplog.text
...
class TestBufferClearFromRedis:
    ...
    @pytest.mark.parametrize("event_keys,clear_count,expected_deletes", [
        (["agent_events:event_1", "agent_events:event_2"], 2, ["event_1", "event_2"]),  # Clear all
        (["agent_events:event_1", "agent_events:event_2", "agent_events:event_3"], 2, ["event_1", "event_2"])  # Partial clear (covers break condition)
    ])
    @pytest.mark.asyncio
    async def test_clear_events_from_redis(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, event_keys: list[str], clear_count: int, expected_deletes: list[str]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_clear_metrics_from_redis(self, buffer: EventBuffer, mock_redis_handler: AsyncMock) -> None:
        mock_redis_handler.keys.return_value = ["agent_metrics:metric_1", "agent_metrics:metric_2"]
        await buffer.initialize_redis(mock_redis_handler)
        await buffer._clear_metrics_from_redis(1)
        assert mock_redis_handler.delete_key.call_count == 1
        mock_redis_handler.delete_key.assert_awaited_once_with("agent_metrics", "metric_1")
    ...
    @pytest.mark.asyncio
    async def test_clear_events_from_redis_exception(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        mock_redis_handler.keys.side_effect = Exception("Redis Error")
        await buffer.initialize_redis(mock_redis_handler)
        await buffer._clear_events_from_redis(1)
    ...
    @pytest.mark.asyncio
    async def test_clear_metrics_from_redis_exception(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        mock_redis_handler.keys.side_effect = Exception("Redis Error")
        await buffer.initialize_redis(mock_redis_handler)
        await buffer._clear_metrics_from_redis(1)
    ...
    @pytest.mark.asyncio
    async def test_clear_redis_buffers(self, buffer: EventBuffer, mock_redis_handler: AsyncMock) -> None:
        mock_redis_handler.keys.side_effect = [
    ...
    @pytest.mark.asyncio
    async def test_clear_redis_buffers_exception(self, buffer: EventBuffer, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        mock_redis_handler.keys.side_effect = Exception("Redis Error")
        await buffer.initialize_redis(mock_redis_handler)
        await buffer._clear_redis_buffers()
...
class TestBufferErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_add_event_exception(self, buffer: EventBuffer, security_event: SecurityEvent, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        await buffer.initialize_redis(mock_redis_handler)
        with patch.object(buffer, '_persist_event_to_redis', side_effect=Exception("Redis Persist Error")):
            await buffer.add_event(security_event)
            assert "Failed to buffer event: Redis Persist Error" in caplog.text


    @pytest.mark.asyncio
    async def test_add_metric_exception(self, buffer: EventBuffer, security_metric: SecurityMetric, mock_redis_handler: AsyncMock, caplog: LogCaptureFixture) -> None:
        await buffer.initialize_redis(mock_redis_handler)
        with patch.object(buffer, '_persist_metric_to_redis', side_effect=Exception("Redis Persist Error")):
            await buffer.add_metric(security_metric)
...
class TestBufferFullImmediateFlush:
    ...
    @pytest.mark.asyncio
    async def test_add_event_full_buffer_flush(self, buffer: EventBuffer, security_event: SecurityEvent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_add_metric_full_buffer_flush(self, buffer: EventBuffer, security_metric: SecurityMetric) -> None:
        buffer.config.buffer_size = 1
        with patch.object(buffer, '_flush_if_needed', new_callable=AsyncMock) as mock_flush:
            await buffer.add_metric(security_metric)
            mock_flush.assert_called_once()
